...
set xlabel "Alpha" #at 650,2.0 right
set ylabel "Error (%)" #at 0.38,85 left
set label "MNIST Gauss" at 1e-3,15 center font "HelveticaBold,30"
...
plot "gaussian-exp.out" u 1:3 t "" w lp lw 2 lt 1 ps 2.0
